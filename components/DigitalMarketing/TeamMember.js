                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <ScrollAnimation animateIn="fadeInUp" delay={50} animateOnce={true}>
                                <div className="single-team-member">
                                    <div className="image">
                                        <img src="/images/team/team13.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <ScrollAnimation animateIn="fadeInUp" delay={100} animateOnce={true}>
                                <div className="single-team-member">
                                    <div className="image">
                                        <img src="/images/team/team14.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <ScrollAnimation animateIn="fadeInUp" delay={150} animateOnce={true}>
                                <div className="single-team-member">
                                    <div className="image">
                                        <img src="/images/team/team15.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <ScrollAnimation animateIn="fadeInUp" delay={200} animateOnce={true}>
                                <div className="single-team-member">
                                    <div className="image">
                                        <img src="/images/team/team16.jpg" alt="team-image" />
